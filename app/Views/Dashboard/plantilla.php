...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?php echo base_url();?>/assets/template/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url(); ?>/public/Usuarios/fotos/<?php echo session('fotoUsuario') ? session('fotoUsuario') : 'guest.jpg'; ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
